...
const showProducts = (products) => {
  ...
  for (const product of allProducts) {
    ...
    <img class="product-image" src= ${product.image}></img>
      ...
      <p><b class="text-danger">${product.rating.rate}</b> of <i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i><i class="fas fa-star"></i>(<b class="text-danger">${product.rating.count}</b> <i class="fas fa-user-check"></i>)</p>
...
const updateTotal = () => {
  ...
  document.getElementById("total").innerText = parseFloat(finalGrandTotal).toFixed(2);
};
loadProducts();
